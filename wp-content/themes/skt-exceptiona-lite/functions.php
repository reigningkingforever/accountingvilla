<?php
/**
 * The MAIN FUNCTIONS FILE for SKT Exceptiona Lite
 *
...
function woocommerce_header_add_to_cart_fragment( $fragments ) {
	...
	?>
	<a class="cart-customlocation" href="<?php echo esc_url(wc_get_cart_url()); ?>" title="d<?php _e('View your shopping cart', 'woothemes'); ?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span class="custom-cart-count"><?php echo $woocommerce->cart->cart_contents_count; ?></span></a>
	<?php
...
function skt_complete_import_files() {
	return array(
		array(
			'import_file_name'             => 'Import SKT Eceptiona Lite Demo',
